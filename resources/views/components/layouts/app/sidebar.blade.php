...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <flux:navlist variant="outline">
        <flux:navlist.group :heading="__('Platform')" class="grid">
            ...
            <flux:navlist.item
                icon="user-plus"
                :href="route('customers.form')"
                :current="request()->routeIs('customers.form')"
                wire:navigate>
                Kund Detaljer
            </flux:navlist.item>
        </flux:navlist.group>
...
{{-- <!DOCTYPE html> These codes are from the old sidebar.blade.php and caused 500 errors because it required login info.
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    <head>
        @include('partials.head')
    </head>
