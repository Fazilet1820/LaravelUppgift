            ...
            <div class="px-8 py-8">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 p-6 rounded-lg">
                        ...
                        <div>
                            <label class="text-sm font-medium text-gray-500 block mb-1">Telefonnummer</label>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 p-6 rounded-lg">
                        <div>
                            <label class="text-sm font-medium text-gray-500 block mb-1">Födelsedatum</label>
                            <p class="text-base text-gray-900 flex items-center">
                                ...
                                @if($customer->date_of_birth)
                                    ...
                                    <span class="ml-2 text-sm text-gray-500">({{ $customer->date_of_birth->age }} år gammal)</span>
                                @else
                                    <span class="text-gray-500">Ej angivet</span>
                                @endif
                            </p>
                        </div>
                    </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 p-6 rounded-lg">
                        <div>
                            <label class="text-sm font-medium text-gray-500 block mb-2">Membership Type</label>
                            <span class="px-4 py-2 inline-flex text-sm leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                {{ $customer->membership_type->value ?? 'Ej angivet' }}
                            </span>
                        </div>
                        <div>
                            <label class="text-sm font-medium text-gray-500 block mb-2">Kundtyp</label>
                            <span class="px-4 py-2 inline-flex text-sm leading-5 font-semibold rounded-full bg-purple-100 text-purple-800">
                                {{ $customer->customer_kind->value ?? 'Ej angivet' }}
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 p-6 rounded-lg">
                        <div>
                            <label class="text-sm font-medium text-gray-500 block mb-1">Registreringsdatum</label>
                        ...
                        <div>
                            <label class="text-sm font-medium text-gray-500 block mb-1">Senast uppdaterad</label>
                            <p class="text-base text-gray-900">
                                {{ $customer->updated_at->format('d.m.Y H:i') }}
                                <span class="text-sm text-gray-500 block">{{ $customer->updated_at->diffForHumans() }}</span>
                            </p>
                        </div>
                    </div>
                </div>
